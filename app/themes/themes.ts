...
const greenPhosphor: TerminalTheme = {
  ...
  colors: {
    ...
    dim: "#1f9e1f",
    ansi: [
      "#0a0f0a", "#1f9e1f", "#33ff33", "#66ff66",
      "#28c828", "#4ded4d", "#39e639", "#99ff99",
      "#146414", "#2bd42b", "#45ff45", "#80ff80",
      "#30dc30", "#5cf75c", "#4bf04b", "#ccffcc",
    ],
  },
  phosphorTint: "#33ff33",
...
const amberPhosphor: TerminalTheme = {
  ...
  colors: {
    ...
    dim: "#a06e00",
    ansi: [
      "#100b02", "#a06e00", "#ffb000", "#ffc94d",
      "#cc8c00", "#e8a000", "#d99a00", "#ffd98c",
      "#5e4100", "#bf8400", "#ffba1f", "#ffd166",
      "#e09800", "#f5aa00", "#eda300", "#ffe9bf",
    ],
  },
  phosphorTint: "#ffb000",
...
const monoWhite: TerminalTheme = {
  ...
  colors: {
    ...
    dim: "#8a8a8a",
    ansi: [
      "#0d0d0d", "#8a8a8a", "#e8e8e8", "#ffffff",
      "#b5b5b5", "#d0d0d0", "#c2c2c2", "#f5f5f5",
      "#4d4d4d", "#a0a0a0", "#dcdcdc", "#ffffff",
      "#c8c8c8", "#e0e0e0", "#d6d6d6", "#ffffff",
    ],
  },
  phosphorTint: "#dcdcdc",
